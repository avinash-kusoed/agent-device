...
export const MAESTRO_NUMERIC_FIELD_CONSTRAINTS: Record<string, NumericScalarConstraints> = {
  ...
  'tapOn.waitToSettleTimeoutMs': { integer: true, nonNegative: true },
  ...
  'scrollUntilVisible.speed': { nonNegative: true },
  'scrollUntilVisible.visibilityPercentage': { nonNegative: true },
  ...
  'travel.speed': { positive: true },
  inputRandomText: { integer: true, positive: true },
  'inputRandomText.length': { integer: true, positive: true },
  inputRandomNumber: { integer: true, positive: true },
  'inputRandomNumber.length': { integer: true, positive: true },
};
